...
<Notes>
  I'm Jonathan, an developer working at Moltin. Moltin is a headless commerce
...
Let your infrastrcuture scale infinitely with your application
...
<Notes>
  ...
  just a couple examples of how serverless architcture is utilised by developers
  across the web. At Moltin, our billing and caching services are backed by
  serverless technologies. Customers utilise our events API to power serverless
  integrations with 3rd party services such as Postmark and Twilio.
</Notes>
...
<Notes>
  Since each function is isolated, it handles it's own responsibilities. We may
...
Use the best laguage for the job

<Notes>
  There is no preconceived laungage in a serverless application, allowing you to
  use the best tooling for the job at hand.
</Notes>
...
<Notes>
  ...
  inside the repository. As each function has it's own package file, this
